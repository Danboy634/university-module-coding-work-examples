...
void EnemyTurtle1::Initialise()
{
	...
	//set position to random position within the zone for this enemy type
	...
	SpritesheetDef* pSpritesheetDef = pGameDataManager->GetSpritesheetDef("sprites/characters/spr_turtle.xml");

	m_AnimatedSprite.AddAnimationFromSpriteSheetDef(E_AnimationState_Idle, pSpritesheetDef, "spr_turtle_idle", 10, true);
	m_AnimatedSprite.AddAnimationFromSpriteSheetDef(E_AnimationState_Walk, pSpritesheetDef, "spr_turtle_walk", 10, true);
	m_AnimatedSprite.AddAnimationFromSpriteSheetDef(E_AnimationState_Precision, pSpritesheetDef, "spr_turtle_precision", 10, false);
	m_AnimatedSprite.AddAnimationFromSpriteSheetDef(E_AnimationState_Death, pSpritesheetDef, "spr_turtle_death", 10, false);
	m_AnimatedSprite.AddAnimationFromSpriteSheetDef(E_AnimationState_Hit, pSpritesheetDef, "spr_turtle_hit", 10, false);
	m_AnimatedSprite.SetCurrentAnimation(E_AnimationState_Idle);

	EnemyBase::Initialise();
}

void EnemyTurtle1::toIdleState()
{
...
void EnemyTurtle1::toWalkingState()
{
...
void EnemyTurtle1::toAttackingState()
{
...
void EnemyTurtle1::UpdateWeapon()
{
	if (m_pWeapon)
	{
...
void EnemyTurtle1::GetPosition(int& x, int& y)
{
	EnemyBase::GetPosition(x, y);
}

void EnemyTurtle1::OnCollision(Collider2D * pCollider2D)
{
