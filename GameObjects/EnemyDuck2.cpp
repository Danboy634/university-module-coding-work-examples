...
void EnemyDuck2::Initialise()
{
	...
	SpritesheetDef* pSpritesheetDef = pGameDataManager->GetSpritesheetDef("sprites/characters/spr_duck2.xml");

	m_AnimatedSprite.AddAnimationFromSpriteSheetDef(E_AnimationState_Idle, pSpritesheetDef, "spr_duck2_idle", 10, true);
	m_AnimatedSprite.AddAnimationFromSpriteSheetDef(E_AnimationState_Walk, pSpritesheetDef, "spr_duck2_walk", 10, true);
	m_AnimatedSprite.AddAnimationFromSpriteSheetDef(E_AnimationState_Precision, pSpritesheetDef, "spr_duck2_death2", 10, false);
	m_AnimatedSprite.AddAnimationFromSpriteSheetDef(E_AnimationState_Death, pSpritesheetDef, "spr_duck2_death3", 10, false);
	m_AnimatedSprite.AddAnimationFromSpriteSheetDef(E_AnimationState_Hit, pSpritesheetDef, "spr_duck2_hit", 10, false);
	m_AnimatedSprite.SetCurrentAnimation(E_AnimationState_Idle);

	EnemyBase::Initialise();
}

void EnemyDuck2::toIdleState()
{
...
void EnemyDuck2::toWalkingState()
{
...
void EnemyDuck2::toAttackingState()
{
...
void EnemyDuck2::GetPosition(int& x, int& y)
{
	EnemyBase::GetPosition(x, y);
}

void EnemyDuck2::OnCollision(Collider2D * pCollider2D)
{
