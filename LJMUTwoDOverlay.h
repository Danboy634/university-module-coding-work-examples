...
namespace LJMUDX
{
	...
	struct LJMUTextEntryOBJ
	{
		...
		LJMUTextEntryOBJ() {};
		LJMUTextEntryOBJ(SpriteFontPtr pfont, std::wstring& ptext, Matrix4f& pxform, Vector4f& pcolour)
		{
			this->font = pfont;
			this->text = ptext;
			this->xform = pxform;
	...
	public:
		...
		void drawText(LJMUTextEntryOBJ pentry);
	...
	protected:
		...
		std::vector<LJMUTextEntryOBJ>      _list_text;
	};
};